...
MOTOR1B=18  #Right Motor
MOTOR1E=22

MOTOR2B=21  #Left Motor
MOTOR2E=19
...
for image in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
      ...
      if (index == 0):
          ...
          if(found==0):
                ...
                print("Left-dist" , distanceL)
                print("Right-dist" , distanceR)
                ...
                print("Found Center-dist" , distanceC)
                print("Found Left-dist" , distanceL)
                print("Found Right-dist" , distanceR)
                if(area<initial):
                      if(distanceC<10):
                            ...
                            if distanceR>=8:
                                  rightturn()
                                  #time.sleep(0.00625)
                                  time.sleep(0.011) #slower version
                                  stop()
                                  time.sleep(0.0125)
                                  forward()
                                  #time.sleep(0.00625)
